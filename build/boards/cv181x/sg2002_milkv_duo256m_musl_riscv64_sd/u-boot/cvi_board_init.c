...
#else
	PINMUX_CONFIG(SD1_D2, PWR_SD1_D2_VO33);    // GP4
	PINMUX_CONFIG(SD1_D1, PWR_SD1_D1_VO34);    // GP5
	PINMUX_CONFIG(SD1_CLK, PWR_SD1_CLK_VO37);  // GP6
	PINMUX_CONFIG(SD1_CMD, PWR_SD1_CMD_VO36);  // GP7
	PINMUX_CONFIG(SD1_D0, PWR_SD1_D0_VO35);    // GP8
	PINMUX_CONFIG(SD1_D3, PWR_SD1_D3_VO32);    // GP9
#endif
