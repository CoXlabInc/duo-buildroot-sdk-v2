...
int chan_query_init(struct morsectrl *mrs, struct mm_argtable *mm_args)
{
    MM_INIT_ARGTABLE(mm_args, "Get a list of available channels",
        json_format = arg_lit0("j", NULL, "Print available channels in JSON format"));
    return 0;
}
