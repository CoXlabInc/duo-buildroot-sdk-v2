...
struct param_entry params[] = {
    ...
    },
    {
        ...
        .name = "snooze_adjust",
        .help = "Adjust the time to snooze for during power save (in usecs) "
                "(positive => longer snooze, negative => shorter snooze)",
    ...
    },
    {
        ...
        .help = "Set a sleep period (usecs) to force the chip to snooze even when not associated. "
    ...
    {
        .id = MORSE_PARAM_ID_HOST_TX_BLOCK,
        .name = "host_tx_block",
        .help = "Block the host from talking to the chip. 0: no blocking, "
                "1: block data and management frames, 2: block commands, 3: block all",
        .min_val = 0,
        .max_val = 3,
        .set_fn = param_set_uint32,
        .get_fn = param_get_uint32,
    ...
    {
        .id = MORSE_PARAM_ID_MEM_RETENTION_CODE,
        .name = "mem_retention_code",
        .help = "Set the memory retention code to be used in snooze",
        .min_val = 0,
        .max_val = 127,
        .set_fn = param_set_uint32,
        .get_fn = param_get_uint32,
